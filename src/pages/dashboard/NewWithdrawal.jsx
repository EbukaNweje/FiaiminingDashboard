...
const NewWithdrawal = () => {
    ...
    .object({ check: z.boolean().refine((val) => val === true, {
     ...
     const { register, handleSubmit, formState: { errors }, setError } = useForm({
      ...
      const handleGetUser = async () => {
        setLoading(true)
        await axios.get(`https://fiaimining-backend.vercel.app/api/userdata/${id}`)
            .then(response => {
                setLoading(false)
  ...
  const url = `https://fiaimining-backend.vercel.app/api/requestwithdrawcode/${id}`
  const urlll = `https://fiaimining-backend.vercel.app/api/withdraw/${id}`
  const urlprofit = `https://fiaimining-backend.vercel.app/api/transferprofittoaccount/${id}`
  const urlemail = `https://fiaimining-backend.vercel.app/api/withdrawalemailsend/${id}`
